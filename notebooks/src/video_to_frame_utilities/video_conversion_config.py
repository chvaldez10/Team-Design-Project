...
class VideoConversionConfig:
    def __init__(self, rgb_metadata: dict, client_schema: dict, blanket_statuses: list, distance_measures: list, frame_rate_config: FrameRateConfig, root_path:str, user_drive: str):
